...
.image-header
        ...
        height :0
        padding-top :100%
       这样写的话height:0;padding-top:100%;或者padding-bottom：100%是宽度的100%，得到的就就是一个长宽相等的,
       相对于盒子的宽度做的
   ...
   import {formatDate,a,b,c} from 'common/js/date';
  import cartcontrol from 'components/cartcontrol/cartcontrol';
  不带花括号的是export default的形式抛出的
  戴花括号的不是default的,多个模块就放在花括号里即可
-->
