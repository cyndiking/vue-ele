...
<!--
 _initScroll() {
           this.menuScroll = new BScroll(this.$refs.menuWrappler, {});
           this.foodsScroll = new BScroll(this.$refs.foodsWrappler, {});
      }

      跟视频里面的不一样，vue2的时候将v-el与v-ref合并ref，具体的查看官网

<li v-for="(item,index) in goods" class="menu-item" :class="{'current':currentIndex===index}" >
跟视频中是不一样的，vue2中取消了$index
http://www.cnblogs.com/mzzz/p/6382590.html
...
<!--
http://www.cnblogs.com/bldf/p/6386791.html
